...
<div class="bg-gray-800 pt-48 pb-40 lg:pb-28 section header-clip">
    ...
    <div class="flex space-x-1 lg:space-x-2 justify-center">
        <div class="flex items-center mb-2">
            <div class="bg-secondary inline-block py-1 px-4 rounded-full">
                <p class="mb-0 capitalize"><?php the_field('location');?></p>
            </div>
        </div>
        <div class="flex items-center mb-2">
            <div class="bg-secondary inline-block py-1 px-4 rounded-full">
                <p class="mb-0"><?php the_field('salary');?></p>
            </div>
        </div>
    </div>
...
<div class="max-w-7xl mx-auto section -mt-20 lg:mt-0">
    <div class="flex flex-wrap">
        <div class="w-full lg:w-[66.6%] lg:pr-20">
            <div class="mb-12">
                <h2 class="text-3xl lg:text-5xl">
                    <?php the_title(); ?>
                </h2>

                <div class="bg-red-200 w-fit px-4 rounded-full">
                    <?php the_field('status');?>
                </div>

                <div class="job-desc lg:pt-8 pt-4">
                    <?php the_content(); ?>
                </div>

                <div class="mt-12 border rounded-xl p-4 lg:p-12">
                    <h4>Meet the recruiter</h4>
                    <div class="flex items-center">
                        <img src="/wp-content/uploads/2023/04/1623324946860.jpeg"
                            class="w-24 h-24 bg-gray-100 rounded-full mr-4">
                        <div>
                            <p class="text-xl mb-1">Nicholas Pope</p>
                            <a href="mailto:info@recruitmentcircle.co.uk">info@recruitmentcircle.co.uk</a>
                        </div>
        ...
        <div class="w-full lg:w-[33.3%]">
            <div class="bg-gray-100 p-6 wpcf7 rounded-lg relative overflow-hidden mb-8">

                <?php if(get_field('status') == 'Position filled') : ?>

                <h3 class="text-center">Sorry, this position has recently been filled!</h3>

                <p class="text-center">If you are looking for more jobs similar to this, contact the team at Recruitment
                    Circle</p>

                <a href="<?php echo get_site_url();?>/contact-us/"
                    class="button button-primary mx-auto w-fit block">Contact us</a>
                <?php else: ?>

                <div>
                    <h3 class="text-center">Easy apply</h3>
                    <form method="post" action="<?php echo home_url('/') . 'application-thank-you/'; ?>">
                        <input type="hidden" name="action" value="submit_job_application">
                        <input type="hidden" name="job_id"
                            value="<?php echo esc_attr(get_post_meta(get_the_ID(), 'job_id', true)); ?>">
                        ...
                        <div class="text-center">
                            <button type="submit" value="Apply now" class="button button-primary w-fit mx-auto">Apply
                                now</button>
                        </div>
                    </form>
                </div>
                ...
                <div class="absolute top-0 left-0 h-full w-full bg-gray-800/70 flex items-center justify-center">
                    <div class="text-center">
                        <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" class="h-32 w-auto mx-auto mb-6"
                        ...
                        <h3 class="mb-3 text-white">Login to apply for this job</h3>

                        <a href="<?php echo get_site_url(); ?>/login/" class="button button-primary mb-6">Login</a>

                        <p class="text-white">Don't have an account? <span
                                class="underline font-medium text-white cursor-pointer" id="openLink">Click here</span>
                        </p>
                    </div>
                </div>
                <?php endif; ?>
            ...
            <div class="bg-gray-100 p-6 wpcf7 rounded-lg relative overflow-hidden mb-8">
                <h3 class="font-bold">Hot tips</h3>
                ...
                foreach ($posts as $post) {
                    setup_postdata($post);
                    ?>
                <div class="border-b mb-3 py-2">
                    <a href="<?php the_permalink(); ?>" class=" flex justify-between items-center">
                        <h4 class="mb-0 text-xl"><?php the_title(); ?></h4>

                        <div class="h-6 w-6 rounded-full bg-secondary flex-shrink-0 flex items-center justify-center">
...
<section class="bg-gray-100 py-12 lg:py-20">
    <div class="container">
        <div class="flex justify-between items-center mb-6">
            <h2 class="lg:mb-0">Recent Jobs</h2>
    ...
    if ($jobs->have_posts()) : ?>
        ...
        ?>
           <article id="post-<?php the_ID(); ?>" <?php post_class('bg-white p-8 flex flex-col justify-between'); ?>>
