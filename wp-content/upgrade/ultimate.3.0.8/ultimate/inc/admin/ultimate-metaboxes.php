...
$sidebar_layout = array(
							'default-sidebar' 		=> array(
															...
															'value' 		=> 'default',
															'label' 		=> __( 'Default Layout Set in', 'ultimate' ).' '.'<a href="'.wp_customize_url() .'?autofocus[section]=ultimate_default_layout" target="_blank" rel="noopener noreferrer">'.__( 'Customizer', 'ultimate' ).'</a>',
															'thumbnail' => ' '
															),
							'no-sidebar' 				=> array(
															'id'			=> 'ultimate_sidebarlayout',
