...
function ultimate_textarea_register($wp_customize){
	class Ultimate_Customize_Ultimate_upgrade extends WP_Customize_Control {
		...
		<div class="theme-info"> 
			<a title="<?php esc_attr_e( 'Review Ultimate', 'ultimate' ); ?>" href="<?php echo esc_url( 'http://wordpress.org/support/view/theme-reviews/ultimate' ); ?>" target="_blank" rel="noopener noreferrer">
			<?php _e( 'Rate Ultimate', 'ultimate' ); ?>
			</a>
			<a href="<?php echo esc_url( 'http://themehorse.com/theme-instruction/ultimate/' ); ?>" title="<?php esc_attr_e( 'Ultimate Theme Instructions', 'ultimate' ); ?>" target="_blank" rel="noopener noreferrer">
			<?php _e( 'Theme Instructions', 'ultimate' ); ?>
			</a>
			<a href="<?php echo esc_url( 'http://themehorse.com/support-forum/' ); ?>" title="<?php esc_attr_e( 'Support Forum', 'ultimate' ); ?>" target="_blank" rel="noopener noreferrer">
			<?php _e( 'Support Forum', 'ultimate' ); ?>
			</a>
			<a href="<?php echo esc_url( 'http://themehorse.com/preview/ultimate/' ); ?>" title="<?php esc_attr_e( 'Ultimate Demo', 'ultimate' ); ?>" target="_blank" rel="noopener noreferrer">
